...
public class NUEVO_RETO_LOTERIA {    
    ...
    public static String heSidoAgraciado(String[] numerosSorteo, String[] premiosSorteo, String miDecimo, String numeroPrimerPremio, String numeroSegundoPremio, String numeroTercerPremio){
    ...
    public static void compruebaDecimos(String[] numerosSorteo, String[] premiosSorteo, String numeroPrimerPremio, String numeroSegundoPremio, String numeroTercerPremio) throws ElGordoException{
        ...
        do {
            ...
            if(!terminarDeComprobar)
                miPremio=heSidoAgraciado(numerosSorteo,premiosSorteo, miDecimo, numeroPrimerPremio, numeroSegundoPremio, numeroTercerPremio);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            compruebaDecimos(listaNumerosSorteo, listaPremiosSorteo, numeroPrimerPremio, numeroSegundoPremio, numeroTercerPremio);
